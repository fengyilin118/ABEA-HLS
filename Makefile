...
CXX      = g++
LANGFLAG = -x c++
CPPFLAGS += -I/opt/xilinx/xrt/include/ -I slow5lib/include/
CFLAGS   += -g -Wall -O2 -std=c++11
LDFLAGS  += $(LIBS) -lpthread -lz -rdynamic -luuid -L/opt/xilinx/xrt/lib/ -lxrt_coreutil -lxilinxopencl -lpthread -lrt -lstdc++ -Wl,-rpath-link,$(XILINX_XRT)/lib
BUILD_DIR = build
...
$(BUILD_DIR)/main.o: src/main.cpp src/f5cmisc.h src/error.h
